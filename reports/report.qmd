...
run_sql_and_return_html(cnx,"""
select re.`Region`, ig.`Income Group`
from
...
run_sql_and_return_html(cnx,"""
select ig.`Income Group`, ig.countriesInIncomeGroup, tc.totalCountries, ig.countriesInIncomeGroup / tc.totalCountries * 100 as percentTotal
from 
